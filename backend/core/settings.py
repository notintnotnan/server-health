...
DEBUG = os.environ.get('DJANGO_DEBUG_STATE','False').lower() == 'true'
...
DATABASES = {
    ...
    'production':{
        ...
        "PASSWORD": os.environ.get('POSTGRES_DATABASE_PASS'),
        "HOST": os.environ.get('POSTGRES_DATABASE_HOST'),
        "PORT": os.environ.get('POSTGRES_DATABASE_PORT')
    }
}

DATABASES['default'] = DATABASES['dev'] if DEBUG else DATABASES['production']
